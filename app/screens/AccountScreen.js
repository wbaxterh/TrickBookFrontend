...
const menuItems = [
	...
	},
	{
		...
		targetScreen: routes.SPINTHEWHEEL,
	},
	// {
	// 	title: "Tutorials",
	// 	icon: {
				...
				<View style={styles.container}>
					{user ? (
						...
						<>
							...
							<ListItem
								title={"Spin the Wheel"}
								onPress={() => navigation.navigate(routes.SPINTHEWHEEL)}
								IconComponent={
									<Icon
										name={"ferris-wheel"}
										backgroundColor={colors.secondary}
							...
							<ListItem
								...
								IconComponent={
									<Icon name={"delete"} backgroundColor={colors.red} />
								}
							/>
						</>
					)}
				...
				<View style={styles.container}>
					{user ? (
						...
						<ListItem
							...
							IconComponent={
								<Icon name={"logout"} backgroundColor={colors.medium} />
							}
						/>
					)}
				</View>

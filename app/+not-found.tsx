  ...
  return (
    <>
      ...
      >
        ...
        <Text className="text-base text-center mb-8" style={{ color: theme.textSecondary }}>
          The page you're looking for doesn't exist.
        </Text>
        <Link href="/" asChild>
          <Pressable className="px-6 py-3 rounded-xl" style={{ backgroundColor: colors.primary }}>
